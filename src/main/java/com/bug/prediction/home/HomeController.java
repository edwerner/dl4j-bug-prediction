package com.bug.prediction.home;
...
class HomeController {
	public static int BATCH_SIZE = 10885;
	public static List<Writable> rawData;
	...
	public static void main(String[] args) throws IOException, InterruptedException {
        ...
        Evaluation eval = new Evaluation(BATCH_SIZE);
        ...
        for(int i = 0; i < predictionErrors.size(); i++){
            ...
            rawData = predictionErrorRawData.get(i).getRecord();
	...
	public HomeController() throws IOException, InterruptedException {
